...
<main>
    ...
    <ul>
        ...
        <li><a href="select_incident.php">Assign Incident</a></li>
        <li><a href="display_incidents.php">Display Incident</a></li>
    </ul>
    <h2>Technicians</h2>
    <ul>
        <li><a href='technician_login.php'>Update Incident</a></li>
    </ul>
    <h2>Customers</h2>
    <ul>
        <li><a href='customer_login.php'>Register Product</a></li>
    </ul>
    </nav>
</section>
